...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <tr>
    <td width="15%"></td>
    <td width="60%">
      地址：<input type="text" name="host" value="mysql" size="10" />
      端口：<input type="text" name="port" value="3306" size="10" />
      用户名：<input type="text" name="login" size="10" value="root" />
      密码：<input type="password" name="password" size="10" value="123456" />
    </td>
    <td width="25%">
...
<div id="footer">
&copy; 2017 <a href="https://ipple.net" target="_blank">IPPLE.NET</a><br />This Prober was based on Yahei Prober.<br />
